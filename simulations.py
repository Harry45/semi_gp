...
# load the LHS points
lhs_points = pd.read_csv('lhs/maximin_1000_7D', index_col=0).values
...
hp.store_arrays(training_points_gg, 'simulations_mean', 'gg')
hp.store_arrays(training_points_gi, 'simulations_mean', 'gi')
hp.store_arrays(training_points_ii, 'simulations_mean', 'ii')